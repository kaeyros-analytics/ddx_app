...
ui <- htmlTemplate("www/index2.html",
                   ...
                   selectclientid = selectInput("selected_client_id", "",
                   ...
                   selectdate = dateRangeInput("daterange3", "",
                   ...
                   selectperiod = selectInput("selected_forecast_period", "",
                                                 choices = sort(c(3, 6, 12)),
                                                 selected = 1,
                                                 selectize = TRUE) # DDX_Visualization
                   
                   # button = actionButton("actionFilter", title="", 
                   #              label= HTML('<i class="bi bi-arrow-clockwise" id= "download" title="Daten speichern">&nbsp; 
                   #                          Filter anwenden</i>'), class = "btn-filter") 
